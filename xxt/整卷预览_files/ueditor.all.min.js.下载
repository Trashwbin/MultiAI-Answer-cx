			...
			if (!utils.isEmptyObject(UE.I18N)) {
				...
				utils.loadFile(document, {
					src : me.options.langPath + me.options.lang + "/"
							+ me.options.lang + ".js?v=2024-1129-1800",
					tag : "script",
	...
	UE.commands['review'] = {
		execCommand : function(cmd) {
			...
			if (img && /img/i.test(img.tagName)
				...
				if (path.indexOf("p.ananas.chaoxing.com") < 0 && path.indexOf("p.cldisk.com") < 0) {
					return;
				}
	...
	(function() {
		...
		var iframeUrlMap = {
			...
			'symbol' : '~/dialogs/symbol/symbol.html' + '#'
					+ window.UEDITOR_CONFIG.DIYDOMAIN,
			'tpupload' : '~/dialogs/tpupload/tpupload.html?v=2024-1129-1840' + '#'
				+ window.UEDITOR_CONFIG.DIYDOMAIN,
           ...
           'calculator' : '~/dialogs/calculator/index.html?v=2023-0920-1700' + '#'
                 	+ window.UEDITOR_CONFIG.DIYDOMAIN,		
           'latex' : '/ananas/common-modules/latex/html/mooc1-index.html?mooc2=1&v=2024-1024-2300' + '#'
 					+ window.UEDITOR_CONFIG.DIYDOMAIN,
           'drawingboard' : '~/dialogs/drawingboard/index.html?v=2023-0718-1700' + '#'
			...
			'recording' : '/ananas/ueditor/dialogs/recoder/recording-workexam.html?_CP_=exam-ans&v=2022-1017-1648',
			'audio' : '~/dialogs/audio/attachmentNew.html?v=2023-1117-1120' + '#' + window.UEDITOR_CONFIG.DIYDOMAIN,
			'insertparseword' : '~/dialogs/insertparseword/insertparseword.html?v=2024-1118-1120' + '#' + window.UEDITOR_CONFIG.DIYDOMAIN
		};
		var btnCmds = [ 'undo', 'redo', 'formatmatch', 'bold', 'italic',
				...
				'tpupload', 'symbol', 'mathml','latex','edrawmath','calculator','drawingboard','insertcodedefined', 'insertparseword'];
		...
		var dialogBtns = {
			...
			ok : [ 'attachment', 'anchor', 'link', 'insertimage', 'map',
					...
					'symbol', 'mathml','recording','audio','edrawmath','latex','calculator','drawingboard','insertparseword']
		};
		var dialogNoBottomBtns=['recording','attachment_new', 'insertimage', 'audio', 'tpupload','edrawmath','calculator','drawingboard','latex', 'insertparseword'];//设置对话框不显示底部按钮
		...
		UE.ui.Editor = function(options) {
			...
			utils.loadFile(document, {
				href : editor.options.themePath + editor.options.theme
						+ "/css/ueditor.css?v=2024-1121-1428",
				tag : "link",
				type : "text/css",
				rel : "stylesheet"
			});
